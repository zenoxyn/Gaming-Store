<x-layout title="Edit Category - Admin">
    <div class="min-h-screen py-8 bg-linear-to-b from-[#1a0b2e] via-[#160b28] to-[#0d0221]">
        <div class="container px-4 mx-auto max-w-4xl">
            ...
            <div class="mb-8">
                ...
                <p class="mt-2 text-gray-400">Update category information and specification template</p>
            </div>
                        ...
                        <div>
                            ...
                            <div class="flex items-start gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <p class="mt-1 text-xs text-gray-500">Max 2MB. Formats: JPG, PNG, WEBP. Leave empty to keep current icon.</p>
                                    @error('icon')
                                        <p class="mt-1 text-sm text-red-400">{{ $message }}</p>
                                    @enderror
                                </div>
    ...
    <script>
        let specFields = @json($category->spec_template ?? []).map((field, index) => ({
            ...field,
            id: Date.now() + index
        }));
